...
class SiteController extends Controller
{
    public function index()
    {
        ...
        $assinaturas = Produto::where('status','1')->orderBy('id', 'DESC')->get();
        ...
        return view('index', compact('assinaturas','revista', 'revistas', 'categorias', 'eventos'));
    }
    ...
    public function getRevistas()
    {
        ...
        return view('paginas.revistas', compact('revistas', 'assinaturas'));
    ...
    public function getNoticias()
    {
        ...
        $noticias = Noticia::where('is_featured', '0')->where('status', '1')->orderBy('id', 'DESC')->get();
    ...
    {
        $materias = Materia::where('status', 1)->orderBy('id','DESC')->get();
