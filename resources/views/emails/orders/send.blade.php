                        ...
                        <table align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" style="width:100%">
                            ...
                            <tr>
                                <td align="center" style="padding-top:40px">
                                    <img src="{{ asset('images/email-images/pedido-enviado.jpg') }}">
                                </td>
                            </tr>
                            <tr>
                                <td align="center" style="padding-top:25px; padding-bottom:20px">
                                    <span style="font-family: 'Open Sans', Arial, Helvetica, sans-serif, serif, EmojiFont; font-size: 34px; font-weight: bold; color: rgb(0, 0, 0); text-align: center;">
                                        <b style="font-family:'Open Sans',sans-serif">seu pedido foi enviado</b>
                                    </span>
                                </td>
                            </tr>
                            </tbody>
                ...
                <tr>
                    <td align="center" class="x_m_-4538126951018225067m-sides-padding" style="padding-left:45px; padding-right:45px; padding-top:20px; padding-bottom:15px">
                        ...
                        <p style="font-family:'Open Sans',sans-serif; font-size:13px; color:#000; line-height:1.4em">
                            Temos boas notícias! Seu pedido <b>{{ $order->order_number }}</b> já está com os correios! :D<br />
                            Fique atento(a) para recebê-lo!
                        </p>
                    </td>
                </tr>
                <tr>
                    <td>
                        <form method="POST" target="_blank" action="http://www2.correios.com.br/sistemas/rastreamento/resultado_semcontent.cfm" class="shipment-details-service__correios">
                            <input type="hidden" name="Objetos" value="{{ $order->tracking }}">
                            <input class="shipment-details-service__correios-action" type="submit" value="Rastrear" style="border: 0; border-radius: 0; background-color: #8a0505; padding: 10px 15px; font-family:'Open Sans',sans-serif; font-size:13px; color:#FFFFFF; line-height:1.4em">
                        </form>
                    </td>
                </tr>
                <tr>
                    <td align="center" style="padding-bottom:20px">
                        <img src="{{ asset('images/email-images/pedido-enviado_timeline.jpg') }}" alt="" border="0" width="382" height="40" style="display:block">
                    </td>
                </tr>
                <tr>
                            ...
                            <tr class="x_m_-4538126951018225067m-full">
                                <td align="center" style="padding-top:20px">
                                    <p style="font-family:'Open Sans',sans-serif; font-size:13px; color:#000; font-weight:bold; text-transform:uppercase">
                                        <b>Confira abaixo os dados do seu pedido</b>
                                    </p>
                                </td>
                            </tr>
                            </tbody>
