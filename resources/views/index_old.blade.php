    ...
    <section class="sectionHome">
        ...
        <div id="carousel-example-1z" class="carousel slide carousel-fade" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
                <div class="carousel-item active">
                    <img class="d-block w-100" src="{{ asset('/images/banner/banner.png') }}" alt="First slide">
                </div>
                <div class="carousel-item">
                    <img class="d-block w-100" src="{{ asset('/images/banner/banner.png') }}" alt="Second slide">
                </div>
                <div class="carousel-item">
                    <img class="d-block w-100" src="{{ asset('/images/banner/banner.png') }}" alt="Third slide">
                </div>
            </div>
        ...
        <div class="container">
            <div class="wrapper">
                <div class="connected-carousels">
                    ...
                    <div class="row rowOutrasEdicoes">
        ...
        <div class="container-fluid">
            <div class="row rowPropaganda">
                <div class="container">
                    <img src="{{ asset('images/propaganda.png') }}" alt="" class="img-fluid">
                </div>
            </div>
        </div>
        ...
        <div class="container-fluid">
            <div class="row rowTitleNot">
                <div class="container">
                    <h1 class="text-left">Notícias sobre <strong>EMPREENDEDORISMO</strong></h1>
                </div>
            </div>
        </div>
        ...
        <div class="container-fluid">
            <div class="row rowPropaganda">
                <div class="container">
                    <img src="{{ asset('images/propaganda2.png') }}" alt="" class="img-fluid">
                </div>
            </div>
        </div>
                        ...
                        <div class="row rowVideosCanal">
                            ...
                            <div class="col-12 col-lg-3 col-md-3">
                                <a href="" class="text-center d-block">
                                    <img src="{{ asset('images/propaganda_lateral.png') }}" alt="" class="img-fluid">
                                </a>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container-fluid">
            <div class="row rowPropaganda">
                <div class="container">
                    <img src="{{ asset('images/propaganda3.png') }}" alt="" class="img-fluid">
                </div>
            </div>
        </div>
