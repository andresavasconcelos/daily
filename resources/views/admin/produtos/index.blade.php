                ...
                <div class="white-box">
                    <form class="form-material form-horizontal">
                        ...
                        <div class="form-group m-b-0">
                            ...
                            <div class="col-md-3">
                                <select class="form-control form-control-line select2" name="visibilidade">
                                    <option value="">- Visibilidade -</option>
                                    <option value="exibir" {{ (Request::get('visibilidade') == 'exibir') ? 'selected' : '' }}>Exibir individualmente</option>
                                    <option value="naoexibir" {{ (Request::get('visibilidade') == 'naoexibir') ? 'selected' : '' }}>Não exibir individualmente</option>
                                </select>
                            </div>

                            <div class="col-md-3">
                                <select class="form-control form-control-line select2" name="tipo">
                                    <option value="">- Tipo -</option>
                                    <option value="simples" {{ (Request::get('tipo') == 'simples') ? 'selected' : '' }}>Simples</option>
                                    <option value="variavel" {{ (Request::get('tipo') == 'variavel') ? 'selected' : '' }}>Variável</option>
                                </select>
                            </div>
            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-wrapper collapse in">
                                            ...
                                            <td>
                                                <a href="{{ url('admin/produto/'.$produto->id.'/editar') }}" class="text-muted">
                                                    ...
                                                    @if($produto->type == 'SIMPLE')
                                                        Tipo: <div class="label label-info">Simples</div>
                                                    @else
                                                        Tipo: <div class="label label-primary">Variável</div>
                                                    @endif
                                                </a>
                                            </td>
                                            <td>
                        ...
                        <span class="m-l-10">{{ $produtos->appends([
                            'q' => Request('q'),
                            'listagem' => Request('listagem'),
                            'filtro' => Request('filtro'),
                            'visibilidade' => Request('visibilidade'),
                            'tipo' => Request('tipo')
                        ])->links('vendor.pagination.bootstrap-4') }}</span>
                    </div>
                </div>
            </div>
        </div>
