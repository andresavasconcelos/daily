            ...
            <div class="col-lg-10 offset-lg-1">
                <section class="content pgAdicionar">
                    <div class="card-header">
                        <h3 class="card-title">EDITAR EDIÇÃO</h3>
                    </div>

                    <form action="{{ url('admin/edicao/editar/'.$editEdicao->id) }}" method="post" enctype="multipart/form-data">
                        {{ csrf_field() }}

                        <div class="form-group">
                            <label for="titulo">Título:</label>
                            <input type="text" class="form-control" id="titulo" placeholder="" name="titulo" value="{{ $editEdicao->titulo }}">
                        </div>

                        <div class="form-group">
                            <label for="descricao">Editorial:</label>
                            <textarea class="form-control conteudo" name="descricao" id="descricao" cols="30" rows="10">{{ $editEdicao->descricao }}</textarea>
                        </div>
