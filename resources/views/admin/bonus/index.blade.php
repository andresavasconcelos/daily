...
@section('content')
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"><a href="{{ url('admin/painel') }}"></a> /Bonus</li>
        </ol>
    </section>
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="text-right mb-3">
                    @if(Request("titulo") != "" )
                        <a href="{{ url("/admin/bonus") }}" class="btn btn-danger btn-sm"><i class="fa fa-close"></i> Limpar filtro</a>
                    @endif
                    ...
                    <div class="collapse" id="collapseExample">
                        <div class="card card-body">
                            <form action="{{ url("admin/bonus") }}" method="get" id="filtro">
                                <div class="row">
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Lista Bônus</h3>
                    </div>
                    <!-- /.card-header -->
                        ...
                        <table id="tabelaBonus" class="table">
                            ...
                            @foreach($bonus as $bonus)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ url('/admin/bonus/editar/'.$bonus->id) }}" class="btn btn-warning btn-sm"><i class="fa fa-pencil"></i> Editar</a>
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
